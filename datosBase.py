...
try:
    ...
    localidades = [
        ...
        localidad(codigoProvincia=1,codigoPostal=3000, nombre="Constitucion", riesgoLocalidad=1.3),
        ...
        localidad(codigoProvincia=4,codigoPostal=3000, nombre="Rio Grande", riesgoLocalidad=1.3),
    ...
    clientes = [
        ...
        cliente(nombre="Marta", apellido="Garcia", idVivienda=2, idDocumento=2, numeroDocumento=42345678),
        ...
        cliente(nombre="Andres", apellido="Sánchez", idVivienda=6, idDocumento=3, numeroDocumento=47654321),
        cliente(nombre="Sofia", apellido="Ramirez", idVivienda=7, idDocumento=1, numeroDocumento=44567812),
        ...
        cliente(nombre="Javier", apellido="Lopez", idVivienda=7, idDocumento=1, numeroDocumento=70944764),
